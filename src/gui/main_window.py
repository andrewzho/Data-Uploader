...
class DataUploaderGUI:
    """
    Main GUI application for Data Uploader.
    
    Provides a tkinter interface for:
    - Managing database connections
    - Uploading Excel/CSV files to SQL Server tables
    ...
    Attributes:
        ...
        operation_queue: Queue for asynchronous operations
        notebook: ttk.Notebook containing all tabs
    """
    
    def __init__(self, root):
        """
        Initialize the Data Uploader GUI.
    ...
    def load_config(self):
        ...
        Returns:
            dict: Configuration dictionary with database and folder settings
        """
    ...
    def get_default_config(self):
        ...
        Returns:
            dict: Default configuration with empty folders and default DB settings
        """
        return {
            "db": {
    ...
    def create_widgets(self):
        """
        Create the main GUI widgets including notebook and all tabs.
    ...
    def create_connection_tab(self):
        ...
        - Authentication configuration (Windows/SQL)
        - Connection testing
        - Table browsing
        """
    ...
    def save_config(self):
        ...
        Updates the config file with current GUI values for:
    ...
    def test_connection(self):
        ...
        Runs connection test in background thread and:
    ...
    def browse_tables(self):
        ...
        Queries INFORMATION_SCHEMA.TABLES and populates the table listbox
        with all accessible base tables for the current database.
        """
        def browse():
            try:
    ...
    def validate_current_files(self):
        ...
        - Column name matching (with fuzzy matching)
    ...
    def upload_current_files(self):
        ...
        Performs the upload operation with:
        - Selected upload mode (append/delete)
    ...
    def refresh_sql_list(self):
        ...
        try:
            ...
            # Check if sql_scripts folder exists
        ...
        def run_sql_process():
            try:
                ...
                if sql_scripts_folder.exists():
                    ...
                    full_paths = [str(sql_scripts_folder / f) for f in selected_files]
                else:
                    # Fall back to project root
                    sql_files = list_sql_files(base)
                    selected_files = [sql_files[i] for i in selected]
                    full_paths = [str(base / f) for f in selected_files]
                ...
                # Run SQL scripts
                run_sql_scripts(full_paths, self.config_path)
